[![Gitpod Ready-to-Code](https://img.shields.io/badge/Gitpod-Ready--to--Code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/RohrerHope/ms1-startup-academy)

<p id="top"></p>

![Code Institute Startup Academy Logo](https://i.imgur.com/HrJMERA.png)
...
#### 1.3.1 To learn more about the programme and what knowledge is shared. 📚
...
#### 1.3.3 To register to participate. 📃

The website provides:

- A "Sign Up" page in which students and graduates can register to join the Academy.

#### 1.3.4 To get in touch with the Startup Academy Team. 📧

The website provides:

- A "Contact" link in the footer which triggers a new email to startupacademy@codeinstitute.net (fictitious email).

#### 1.3.5 To access the dedicated Slack channel for the Academy. 💬
...
- **Simen Daehlin _(Slack user @Eventyret_mentor)_**: Thanks for your support when I had the background image issue, caused by the CSS property background-attachment.
